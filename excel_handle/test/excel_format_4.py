...
aSourceFields = [
    SourceFieldMeta(SourceFieldName="Date", AliasName="Date", Required=False, DataType=datetime.date, DataConvertRequired=False, SourceDataFormat="", IsGrouped=True, GroupedLevel=1, ShouldBe=True ),
    SourceFieldMeta(SourceFieldName="Num", AliasName="Num", Required=False, DataType=str, DataConvertRequired=False, SourceDataFormat="", IsGrouped=True, GroupedLevel=1 ),
    SourceFieldMeta(SourceFieldName="Name", AliasName="Name", Required=False, DataType=str, DataConvertRequired=False, SourceDataFormat="", IsGrouped=True, GroupedLevel=2, ShouldBe=True ),
...
oMyExcelReader = MyExcelReader("test_data/GL_format_4.xlsx", aFieldStr=aSourceFields)
